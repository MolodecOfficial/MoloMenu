...
import ru.bmprojects.molomenu.mixin.ScreenAccessor;

public class MoloScreen extends Screen implements ILayoutConsumer {
    private TextureManager textureManager;

    public MoloScreen(Component screenText) {
        super(screenText);
    }
    ...
    public void tick() {
        ((ScreenAccessor) this).children().forEach(widget -> {
            if (widget instanceof MoloWidget) ((MoloWidget) widget).tick();
        });
    }
